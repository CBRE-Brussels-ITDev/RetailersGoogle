...
function App() {
  ...
  const [showResidentialView, setShowResidentialView] = useState(false);
  ...
  return (
    <div style={{ position: 'relative', height: '100vh', width: '100vw' }}>
      ...
      {showResidentialView ? (
        <ResidentialView onBack={() => setShowResidentialView(false)} />
      ) : (
        <>
          ...
          <div style={{ 
            ...
            {/* Quick View Toggle - Top Right */}
            <div style={styles.viewToggle}>
              <button
                onClick={() => setShowResidentialView(true)}
                style={styles.toggleButton}
                title="Switch to Residential View"
              >
                🏠 Residential
              </button>
            </div>
